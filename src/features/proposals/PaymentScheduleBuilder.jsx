    ...
    <Card className="p-[var(--spacing-lg)] max-w-2xl">
        ...
        <Button
          ...
          onClick={() =>
            sync([
              ...draft,
              {
                label: `Milestone ${draft.length + 1}`,
                percent: 0,
              },
            ])
          }
      ...
      {draft.length === 0 ? (
        ...
        <div className="space-y-[var(--spacing-sm)]">
          ...
          <p
            className={`text-[var(--text-xs)] ${isValid ? 'text-[var(--color-text-subtle)]' : 'text-[var(--color-danger)]'}`}
