 ...
 * primitives. Mirrors the structure of ProposalRenderer.jsx but uses that library's own
...
const styles = StyleSheet.create({
  ...
  row: {
    ...
    paddingVertical: 3,
    borderBottom: '0.5pt solid #e5e3de',
  },
  totalsRow: {
    flexDirection: 'row',
...
export function ProposalPdfDocument({ proposal, context }) {
