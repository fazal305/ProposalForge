...
export function PublicProposalPage() {
  ...
  const submit = (d: ApprovalDecision) => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] py-[var(--spacing-2xl)] px-[var(--spacing-md)]">
      <ProposalRenderer proposal={proposal} context={context} theme={theme} developerLogoDataUrl={profile.logoDataUrl} />
      ...
      <div className="max-w-[840px] mx-auto mt-[var(--spacing-lg)]">
        <Card className="p-[var(--spacing-lg)]">
          ...
          {alreadyDecided || submitted ? (
            ...
            <div>
              <h2 className="text-[var(--text-base)] font-semibold text-[var(--color-text)] mb-[var(--spacing-sm)]">Your Response</h2>
