...
export function NewProposalPage() {
    ...
    const proposal = createProposal(
      {
        ...
        sections: template.sections
          ...
          .map((s) => ({ sectionKey: s.key, title: s.title, contentMd: s.contentMd, orderIndex: s.orderIndex })),
      },
  ...
  return (
    <div>
      <PageHeader title="New Proposal" description="Pick a project and starting template — you'll customize everything next." />
