...
export function SettingsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Settings"
        description="Your reusable profile and business defaults — edit once, applied everywhere."
      />
        ...
        <Card className="p-[var(--spacing-lg)] space-y-[var(--spacing-md)]">
          ...
          <div className="flex items-center gap-[var(--spacing-md)]">
            ...
            <Button
              ...
              onClick={() => {
                updateProfile({
                  logoDataUrl: generateInitialsLogo(profile.businessName || profile.name, '#1f4d3d', '#b98a4e'),
                })
                flash()
              }}
            >
        ...
        <div className="space-y-[var(--spacing-lg)]">
          <Card className="p-[var(--spacing-lg)] space-y-[var(--spacing-md)]">
            ...
            <Field label="Default Pricing Mode">
              <select
                ...
                onChange={(e) =>
                  updateProfile({
                    defaultPricingMode: e.target.value,
                  })
                }
          ...
          <Card className="p-[var(--spacing-lg)] space-y-[var(--spacing-sm)]">
            ...
            <div className="grid grid-cols-2 gap-[var(--spacing-sm)]">
              <Field label="Prefix">
                <Input
                  value={proposalNumberPrefix}
                  onChange={(e) =>
                    setState({
                      proposalNumberPrefix: e.target.value,
                    })
                  }
                />
              </Field>
              <Field label="Next Number">
                <Input
                  ...
                  onChange={(e) =>
                    setState({
                      nextProposalNumber: Number(e.target.value),
                    })
                  }
                />
              </Field>
      ...
      <Card className="p-[var(--spacing-lg)] mt-[var(--spacing-lg)]">
        <h2 className="text-[var(--text-sm)] font-semibold text-[var(--color-text)] mb-[var(--spacing-2xs)]">
          Terms Library
        </h2>
        <p className="text-[var(--text-xs)] text-[var(--color-text-subtle)] mb-[var(--spacing-md)]">
          {LEGAL_REVIEW_NOTE}
        </p>
