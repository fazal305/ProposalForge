...
function section(templateId, key, title, type, contentMd, orderIndex) {
  return {
    id: generateId('sec_'),
    templateId,
    key,
...
export function buildDefaultSoftwareTemplate(templateId) {
  ...
  return [
    section(
      ...
      'Cover',
      'DYNAMIC',
      '# Software Development Proposal\n\nPrepared for {{client.company}}\nBy {{developer.name}}\n\nProposal {{proposal.number}} · {{proposal.date}}',
      0,
    ),
    ...
    section(
      ...
      'The Problem',
      'DYNAMIC',
      '[Describe the problem this project solves for {{client.company}}.]',
      2,
    ),
    section(
      templateId,
    ...
    section(
      ...
      'Scope of Work',
      'DYNAMIC',
      'The scope below outlines everything included in this engagement.',
      4,
    ),
    section(
      templateId,
      ...
      'Deliverables',
      'DYNAMIC',
      'All items marked as included in the Scope of Work above will be delivered as functioning, tested software.',
      5,
    ),
    section(
      templateId,
      ...
      'Timeline & Milestones',
      'DYNAMIC',
      'Estimated project timeline: {{project.timeline}}',
      6,
    ),
    section(
      templateId,
      ...
      'Investment',
      'DYNAMIC',
      'Total investment for this project: {{proposal.total}} {{proposal.currency}}',
      7,
    ),
    section(
      templateId,
      ...
      'Payment Schedule',
      'DYNAMIC',
      'Payment is split across the milestones below.',
      8,
    ),
